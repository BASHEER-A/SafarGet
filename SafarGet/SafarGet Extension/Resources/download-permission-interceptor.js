// =================================================
// 🎯 اعتراض نافذة Download Permission - الحل الذهبي
// =================================================
// هذا الحل يستغل نافذة "Download Permission" في Safari
...
(function() {
    ...
    // =================================================
    // 5️⃣ اعتراض أحداث Safari الخاصة
    // =================================================
    
    // Safari يطلق أحداث خاصة عند التحميل
    ...
    // =================================================
    // 8️⃣ Safari-specific: اعتراض download attribute
    // =================================================
        ...
        while (element && element !== document.body) {
            if (element.tagName === 'A') {
                ...
                if (element.hasAttribute('download') || element.download) {
                    ...
                    // في Safari، هذا سيؤدي لظهور نافذة الإذن
